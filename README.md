...
```
cd existing_repo
git remote add origin https://yyz-gitlab.local.tenstorrent.com/syseng-platform/tt-firmware-gs.git
git branch -M main
...
- [ ] [Set up project integrations](https://yyz-gitlab.local.tenstorrent.com/syseng-platform/tt-firmware-gs/-/settings/integrations)
